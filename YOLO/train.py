...
from utils import draw, generate_color, max_confidence_bounding_box ,yolo_format_to_bounding_box_info
...
def save_validation_result(model, ckpt, validation_summary_writer, num_visualize_image):
  ...
  for validation_image_index in range(num_visualize_image):
    ...
    for i in range(cell_size):
      for j in range(cell_size):
        for k in range(boxes_per_cell):
          ...
          bounding_box_info_list.append(yolo_format_to_bounding_box_info(pred_xcenter, pred_ycenter, pred_box_w, pred_box_h, pred_class_name, pred_confidence))
    ...
    max_confidence_bounding_box = max_confidence_bounding_box(bounding_box_info_list)
